...
<body>
  <div class="wrapper">
    <div class="upper_part">
      ...
      <main>
        <div class="cards">
          <div class="card">
          <div class="warning reminder hide">標題或內容為空白</div>
          ...
          <?php } ?>
            ...
            <form method="POST" action="handle_add_blog.php">
              <div><input type="text" class="enter_blog_title" placeholder="標題" name="blog_title"/></div>
  ...
  <script>
    CKEDITOR.replace('editor1', {
      ...
      editorplaceholder: '寫點什麼....'
    });

    document.querySelector("form").addEventListener("submit", 
      (e) => {
        let title = document.querySelector(".enter_blog_title")
